...
$_LANGMAIL['New voucher for your order %s'] = 'Nowy bon do zamówienia %s';
...
$_LANGMAIL['Package in transit'] = 'Dostawa w trakcie realizacji';
...
$_LANGMAIL['Your message has been correctly sent #ct%1$s #tc%2$s'] = 'Twoja wiadomość została prawidłowo wysłana #ct%1$s #tc%2$s';
